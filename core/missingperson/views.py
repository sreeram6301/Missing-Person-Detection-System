...
#                         from_email = 'mrcet.cseb.2025@gmail.com'
...
#                         # Send the email
#                         send_mail(subject,'Hello', from_email, [recipientmail], fail_silently=False, html_message=html_message)
...
def update_person(request, person_id):
    ...
    if request.method == 'POST':
        ...
        person.father_name = request.POST.get('fathers_name', person.father_name)
        person.date_of_birth = request.POST.get('dob', person.date_of_birth)
        person.address = request.POST.get('address', person.address)
        person.email = request.POST.get('email', person.email)
        person.phone_number = request.POST.get('phonenum', person.phone_number)
        person.aadhar_number = request.POST.get('aadhar_number', person.aadhar_number)
        person.missing_from = request.POST.get('missing_date', person.missing_from)
